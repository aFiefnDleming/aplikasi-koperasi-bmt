	        	...
	        	<?php 
				  ...
				  if(isset($_POST['login'])){			                           
			                ...
			                if(mysqli_num_rows($sql_login) > 0){
			                    ...
			                    echo "<script>window.location='http://localhost/bmt/anggota/dashboard/';</script>";
			                } else { ?>
			                    <div class="row">
			                        <div class="">
			                ...
			                if(mysqli_num_rows($sql_login) > 0){
			                    ...
			                    echo "<script>window.location='http://localhost/bmt/anggota/dashboard-nasabah/';</script>";
