            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#body">
						<h1 id="logo">
							<img src="frontend/img/bmt_logo.jpg" class="img-circle" width="80" alt="BMT Mitra Khazanah">
						</h1>
					</a>
					<!-- /logo -->
                </div> 
                <a href="http://localhost/bmt/anggota/" target="_blank" class="btn btn-success" style="margin-top: 9px; float: right;">Login</a>
				<!-- main nav -->
				...
				<div class="carousel-inner" role="listbox">
					...
					<div class="item active" style="background-image: url(frontend/img/header.jpg);">
						<div class="carousel-caption">
							...
							<p data-wow-duration="1000ms" class="wow bounceInDown animated">Baitul Maal wa Tamwil - BMT</p>
							
								<h2 data-wow-duration="700ms" data-wow-delay="500ms" class="wow bounceInDown animated">BMT<span> Mitra Khazanah</span></h2>
							</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="sec-sub-title text-center wow fadeInRight animated" data-wow-duration="500ms">
						<p>Berikut Pengurus Inti BMT Mitra Khazanah</p>
					</div>
					<?php 					
